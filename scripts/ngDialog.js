                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            scope.copyToClipboard = function (eleId) {
                                $rootScope.$broadcast('ngDialog.copyToClipboard', eleId);
                            };

                            scope.saveToDatabase = function (data) {
                                $rootScope.$broadcast('ngDialog.saveToDatabase', data);
                            };
